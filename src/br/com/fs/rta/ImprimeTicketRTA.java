...
public class ImprimeTicketRTA {
    ...
    public ImprimeTicketRTA(String nomeRelatorio, Map parametros) throws SQLException, JRException, Exception {
        ...
        try {
            ...
            JasperPrintManager.printPage(jp, paginas - 1, true);
