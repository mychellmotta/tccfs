...
public class ConsultaAjusteProdTableModel extends AbstractTableModel {

    private final String colunas[] = {"Código", "Nome", "Em estoque", "Preço de custo"};
            ...
            case 2:
                if (produto.getQtd() > 0) {
                    ...
                    try {
                        ...
                        Logger.getLogger(ConsultaAjusteProdTableModel.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
            case 3:
                return ReplaceMoedaRTA.doubleToMoeda(produto.getPrecocusto());
            default:
