...
import br.com.fs.tm.ConsultaProdutosPromocaoTableModel;
...
public class ConsultaProdutosPromocaoGUI extends javax.swing.JDialog {

    private final PromocaoGUI parent;

    public ConsultaProdutosPromocaoGUI(PromocaoGUI pai) {
        super();
        parent = pai;
        initComponents();
        this.construtor();
    ...
    private void atualizarBusca(String query) {
        try {
            ConsultaProdutosPromocaoTableModel p = (ConsultaProdutosPromocaoTableModel) tbBusca.getModel();
            ...
            p.setDados(dao.produtosFinaisAtivos(query));
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        pnParametros.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Parâmetro de busca", 0, 0, new java.awt.Font("Tahoma", 1, 11))); // NOI18N
        ...
        btBuscar.setPreferredSize(new java.awt.Dimension(49, 20));
        ...
        pnParametrosLayout.setVerticalGroup(
            ...
            .addGroup(pnParametrosLayout.createSequentialGroup()
                ...
                .addGroup(pnParametrosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btBuscar, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        tbBusca.setModel(new ConsultaProdutosPromocaoTableModel());
    ...
    private void btBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btBuscarActionPerformed
        ...
        if (nome.length() == 0) {
            ...
            try {
                atualizarBusca("AND nome LIKE '%" + nome + "%' ");
            } catch (Exception e) {
                JOptionPane.showMessageDialog(this, "Erro: " + e.getMessage(), "Erro",
                        JOptionPane.ERROR_MESSAGE);
            }
